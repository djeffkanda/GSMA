...
relative_move_data$relative_move = apply(relative_move_data,1,
                                         FUN = function(x){
...
ginfcurv = ggplot() + geom_line(data=epidemic_curve,mapping=aes(x=Date,y=inf, color = "#0072B2"))+ 
  geom_line(data=epidemic_curve_,mapping=aes(x=Date,y=inf,color ="#44444")) + 
  ylab('New cases')+
