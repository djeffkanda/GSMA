...
#relative_move_data=expand.grid(date =  seq.Date(from = as.Date("2020-01-01"), to = as.Date("2020-02-01"),by="day"),from = patNames,relative_move = 1,relative_contact = 1)

relative_move_data = mvt_red
relative_move_data$relative_contact = relative_move_data$relative_move
